...
class Schema(dict):
    ...
    def graphviz(self, idmef_class, direction='LR', link_format=None, format='svg'):
        dot = graphviz.Graph(comment=idmef_class, format=format)
    ...
    def svg(self, idmef_class, direction='LR', link_format=None):
        dot = self.graphviz(idmef_class, direction, link_format, format='svg')
...
if __name__ == "__main__":
    ...
    schema.gen_all("htdocs/graph", link_format="/help/idmefnav?idmef_class=%s")
